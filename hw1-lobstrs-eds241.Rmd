...
d.  Discuss the following causal inference assumptions in the context of the MPA treatment effect estimator. Evaluate if each of the assumption are reasonable:
    ...
    1)  SUTVA: Stable Unit Treatment Value assumption
        ...
        SUTVA assumptions are the following: No interference and no hidden variations of treatment. There is possible interference within this study as spillover from MPAs can likely cause higher counts in non-MPAs.

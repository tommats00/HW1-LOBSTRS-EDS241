...
mpa <- spiny_counts %>% 
    mutate(mpa = ifelse(site %in% c("IVEE", "NAPL"), "MPA", "non-MPA"),
           treat = ifelse(site %in% c("IVEE", "NAPL"), 1, 0))
...
beeswarm::beeswarm(data = spiny_counts, mean_size ~ site)
...
The intercept coefficient represents the y-intercept when treat = 0. The treat coeffcieint represents the slope of our linear regression line.
